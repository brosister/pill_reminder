...
class _PillReminderHomePageState extends State<PillReminderHomePage> {
  ...
  Future<void> _seedPreviewData({required bool english}) async {
    final now = DateTime.now();
    final todayKey = MedicationLogService.instance.todayKey(now);
    final yesterdayKey = MedicationLogService.instance.todayKey(
      now.subtract(const Duration(days: 1)),
    );
    final twoDaysAgoKey = MedicationLogService.instance.todayKey(
      now.subtract(const Duration(days: 2)),
    );
    final threeDaysAgoKey = MedicationLogService.instance.todayKey(
      now.subtract(const Duration(days: 3)),
    );

    final seededMedications = english
        ? const [
            MedicationItemState(
              name: 'Vitamin D',
              takenToday: true,
    ...
    final seededLogs = english
        ? [
            DoseLog(
              title: 'Taken at 08:10',
              time: '08:10',
              skipped: false,
              medicationNames: const ['Vitamin D', 'Omega 3'],
              dateKey: todayKey,
            ),
            DoseLog(
              title: 'Skipped at 13:20',
              time: '13:20',
              skipped: true,
              medicationNames: const ['Blood Pressure Med'],
              dateKey: todayKey,
            ),
            DoseLog(
              title: 'Taken at 21:05',
              time: '21:05',
              skipped: false,
              medicationNames: const ['Vitamin D', 'Blood Pressure Med'],
              dateKey: yesterdayKey,
            ),
            DoseLog(
              title: 'Taken at 08:00',
              time: '08:00',
              skipped: false,
            ...
            DoseLog(
              title: 'Skipped at 14:30',
              time: '14:30',
              skipped: true,
              medicationNames: const ['Omega 3'],
              dateKey: twoDaysAgoKey,
            ),
            DoseLog(
              title: 'Taken at 08:40',
              time: '08:40',
              skipped: false,
              medicationNames: const ['Vitamin D', 'Blood Pressure Med'],
              dateKey: twoDaysAgoKey,
        ...
        : [
            DoseLog(
              ...
              time: '08:10',
              skipped: false,
              medicationNames: const ['비타민 D', '오메가3'],
              dateKey: todayKey,
            ),
            DoseLog(
              title: '13:20 복약 건너뜀',
            ...
            DoseLog(
              ...
              time: '21:05',
              skipped: false,
              medicationNames: const ['비타민 D', '혈압약'],
              dateKey: yesterdayKey,
            ),
            DoseLog(
              title: '08:00 복약 완료',
              time: '08:00',
              skipped: false,
              medicationNames: const ['비타민 D', '오메가3', '혈압약'],
              dateKey: yesterdayKey,
            ),
            DoseLog(
              title: '14:30 복약 건너뜀',
    ...
    final seededHistory = List.generate(6, (index) {
      ...
      return DailyMedicationSummary(
        dateKey: MedicationLogService.instance.todayKey(day),
        takenCount: values.$1,
        skippedCount: values.$2,
        goalCount: 3,
      );
    });
    ...
    setState(() {
      ...
      _cycleStatuses
        ..clear()
        ..addAll(const ['taken', 'skipped']);
      _takenDoses = 1;
      _medications
        ..clear()
        ..addAll(seededMedications);
      _logs
        ..clear()
        ..addAll(seededLogs);
      _history
        ..clear()
        ..addAll(seededHistory);
      _emptyMedicationWarningDismissed = true;
    });
    ...
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (_) => PillSettingsPage(
          ...
          onSeedKoreanPreviewData: () => _seedPreviewData(english: false),
          onSeedEnglishPreviewData: () => _seedPreviewData(english: true),
        ),
      ),
    );
  }
